              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filterProducts().map((product) => (
                  <tr key={product.sys_id} className="hover:bg-gray-50 transition">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900">{product.u_market_segment}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="text-sm text-gray-900 font-medium">${product.u_price}</div>
                      <div className="text-xs text-gray-500">{product.u_unit_of_measure}</div>
                    </td>
                    <td className="px-6 py-4 whitespace-nowrap">
